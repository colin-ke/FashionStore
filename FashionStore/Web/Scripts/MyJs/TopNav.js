...
TB.Header = function () {
    ...
    var i ={
            getCookie: function (w) {
                ...
                w = g(w);
                if (!w || !v) { return } if (this.hasClass(w, v)) { return } w.className += " " + v
                ...
                if (v.stopPropagation) {
                    v.stopPropagation()
                } else { v.cancelBubble = true } if (v.preventDefault) {
                    v.preventDefault()
                } else {
                    v.returnValue = false
                }
    ...
    function f(W, V) {
        var z = g(W), K = z && z.q, x = z && z.search_type, E = z && z.getElementsByTagName("label")[0], D = z && z.cat, S = g("J_TSearchTabs").getElementsByTagName("li"), v = S.length, P = {}, I = false, F = false, y = "tsearch-tabs-active";
        var N = function (Y) {
            for (var X = 0; X < v; X++) {
                i[X === Y ? "addClass" : "removeClass"](S[X], y)
            }
        };
        var R = g("J_TSearchCat"), U = null, w = g("J_TSearchCatHd"), A = R && R.getElementsByTagName("div")[0], C = A && A.getElementsByTagName("a") || [], H = C.length, Q;
        var G = function (X) {
            for (Q = 0; Q < H; Q++) {
                if (C[Q].getAttribute("data-value") === X) { return C[Q] }
            } return null
        };
        var M = function () { i.removeClass(R, "tsearch-cat-active") };
        var T = function () { i.addClass(R, "tsearch-cat-active") };
        var L = function (X) {
            for (Q = 0; Q < H; Q++) { i[C[Q] === X ? "addClass" : "removeClass"](C[Q], "tsearch-cat-selected") } M();
            w.innerHTML = X.innerHTML; D.value = X.getAttribute("data-value")
        }, J = function () {
            K.focus();
            if (o) {
                K.value = K.value
        ...
        i.addEvent("J_TSearchCat", "click", function (X) {
            ...
            switch (true) {
                case i.hasClass(Y.parentNode, "tsearch-cat-hd"): case i.hasClass(Y, "tsearch-cat-hd"): T(); break; case Y.parentNode.nodeName.toLowerCase() === "div": L(Y); J(); break
            }
        });
        ...
        setTimeout(function () {
            if (!F) {
                ...
                if (document.domain.indexOf("shopsearch.taobao.com") > -1) { x.value = "shop" }
                var X = P[x.value];
                E.innerHTML = X.hint;
                N(X.index)
            }
    ...
    function b(C) {
        ...
        if (!A) {
            return
        } if (!(window.TB && TB.Suggest)) { return; }
    ...
    function n(v) {
        ...
        if (!w) {
            ...
            setTimeout(function () { location.href = x }, 20)
        })
    }
    function h() {
        if (document.domain.indexOf(".taobao.net") === -1) {
            return
        } var y = document.getElementById("header"), x = y ? y.getElementsByTagName("a") : [], w = 0, v = x.length, z = location.hostname.split("."); while (z.length > 3) { z.shift() } z = z.join("."); for (; w < v; w++) { x[w].href = x[w].href.replace("taobao.com", z) }
    }
    function u() {
        ...
        init: function (w) {
            ...
            if (g("J_TSearch")) {
                ...
                setTimeout(function x() {
                    if (typeof x.count == "undefined") { x.count = 0 } x.count++;
                    if (!(window.TB && TB.Suggest)) {
                        setTimeout(arguments.callee, 200)
                    } else { b("J_TSearchForm") }
                }, 200)
            }
            ...
            var y = "";
            if (q) {
                y = '\u60a8\u597d\uff0c<a class="user-nick" href="/Content/images/' + G + '" target="_top">' + i.escapeHTML(unescape(t.replace(/\\u/g, "%u"))) + "</a>\uff01";
                y += '<a id="J_Logout" href="/Content/images/' + C + '" target="_top">\u9000\u51fa</a>';
                y += '<a href="/Content/images/' + E + '" target="_top">\u7ad9\u5185\u4fe1';
                if (p) {
                    y += "(" + p + ")"
                } y += "</a>"
            } else {
                y = '\u60a8\u597d\uff0c\u6b22\u8fce\u6765\u6dd8\u5b9d\uff01<a href="/Content/images/' + D + '" target="_top">\u8bf7\u767b\u5f55</a>';
                y += '<a href="/Content/images/' + B + '" target="_top">\u514d\u8d39\u6ce8\u518c</a>'
            } document.write(y)
        }
    }
}();
