...
document.write('<link href="/Content/pop.css" type="text/css" rel="stylesheet">' + '');
goN2LibMon.monitorLoad("utilities");
goN2LibMon.monitorLoad("events");
goN2LibMon.monitorLoad("simplePopover");
document.write('<script language="javascript" src="/Scripts/MyJs/a_20051231.js" type="text/javascript"></script><\/script>' + '<script language="javascript" src="/Scripts/MyJs/c_20051231.js" type="text/javascript"></script><\/script>' + '<script language="javascript" src="/Scripts/MyJs/b_20051231.js" type="text/javascript"></script><\/script>' + '');
